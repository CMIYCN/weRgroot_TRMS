...
--RUN ALL TO TRUNCATE REIMBURSEMENT_FORM
ALTER TABLE REIMBURSEMENT_FORM DISABLE CONSTRAINT FK_EVENT_TYPE_R;
ALTER TABLE REIMBURSEMENT_FORM DISABLE CONSTRAINT FK_EMP_ID;
ALTER TABLE REIMBURSEMENT_FORM DISABLE CONSTRAINT SYS_C005160;
ALTER TABLE APPROVALS DISABLE CONSTRAINT FK_FORM_ID;
TRUNCATE TABLE REIMBURSEMENT_FORM;
TRUNCATE TABLE APPROVALS;
ALTER TABLE REIMBURSEMENT_FORM ENABLE CONSTRAINT FK_EVENT_TYPE_R;
ALTER TABLE REIMBURSEMENT_FORM ENABLE CONSTRAINT FK_EMP_ID;
ALTER TABLE APPROVALS ENABLE CONSTRAINT FK_FORM_ID;
