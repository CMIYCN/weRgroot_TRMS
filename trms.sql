...
CREATE OR REPLACE PROCEDURE SET_SUPERVISOR_APPROVAL(
SUPERVISOR IN NUMBER,
FORMID IN NUMBER
)
AS
...
CREATE OR REPLACE PROCEDURE SET_DEPARTMENT_APPROVAL(
DEPARTMENT IN NUMBER,
FORMID IN NUMBER
)
AS
BEGIN
UPDATE APPROVALS
SET APPROVALS.DEPARTMENTHEAD = DEPARTMENT
WHERE APPROVALS.FORM_ID = FORMID;
END;
/
--SET BENCO APPROVAL BY FORM ID
CREATE OR REPLACE PROCEDURE SET_BENCO_APPROVAL(
BENCO IN NUMBER,
FORMID IN NUMBER
)
AS
